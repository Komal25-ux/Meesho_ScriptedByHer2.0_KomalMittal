...
Python port of that file (generated from it, not hand-typed) so the reseller
dashboard's charts and the Growth Agent's spoken analysis always tell the same
story from the same underlying transactions. If mockSalesData.js changes,
regenerate this file to match rather than editing the two independently.
"""
